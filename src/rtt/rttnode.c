...
struct node *n;
int nd_id, tok_id1, tok_id2;
   {
   if (n && n->nd_id == nd_id && n->tok &&
	 (n->tok->tok_id == tok_id1 || n->tok->tok_id == tok_id2))
      return n;
   return NULL;
   }

...

struct node *
nav_t_n_is_a(n, nd_id1, tok_id1, child1, nd_id2, child2, nd_id3)
struct node *n;
int nd_id1, nd_id2, nd_id3, tok_id1;
int child1, child2;
   {
   struct node *nd1, *nd2;
   if ((nd1 = nav_t_n(n, nd_id1, tok_id1, child1, nd_id2, child2)))
      if ((nd2 = is_a(nd1, nd_id3)))
	 return nd2;
   return NULL;
   }

...

struct node *
nav_t_is_a(n, nd_id1, tok_id1, child1, nd_id2)
struct node *n;
int nd_id1, tok_id1, child1, nd_id2;
   {
   struct node *nd;
   if ((nd = nav_t(n, nd_id1, tok_id1, child1)))
      return is_a(nd, nd_id2);
   return NULL;
   }

struct node *
...

struct node *
nav_t_is_tt(n, nd_id1, tok_id1, child1, nd_id2, tok_id21, tok_id22)
struct node *n;
int nd_id1, tok_id1, child1, nd_id2, tok_id21, tok_id22;
   {
   struct node *nd;
   if ((nd = nav_t(n, nd_id1, tok_id1, child1)))
      return is_tt(nd, nd_id2, tok_id21, tok_id22);
   return NULL;
   }

struct node *
nav_t_is_ttt(n, nd_id1, tok_id1, child1, nd_id2, tok_id21, tok_id22, tok_id23)
struct node *n;
int nd_id1, tok_id1, child1, nd_id2, tok_id21, tok_id22, tok_id23;
   {
   struct node *nd;
   if ((nd = nav_t(n, nd_id1, tok_id1, child1)))
